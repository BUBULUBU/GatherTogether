...
public abstract class UserInterface : MonoBehaviour
{
    ...
    private void Update()
    {
        slotsOnInterface.UpdateSlotDisplay(); // FIX THIS LATER FOR PERFORMANCE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    }
    ...
    public void OnEnterInterface(GameObject obj)
    {
        ...
        //Debug.Log("New interface: " + obj.GetComponent<UserInterface>());
    }
    ...
    public void OnDragEnd(GameObject obj)
    {
        ...
        {
            if (slotsOnInterface[obj].item.Id <= -1) return;

            InventorySlot mouseHoverSlotData = MouseData.interfaceMouseIsOver.slotsOnInterface[MouseData.slotHoveredOver];
            inventory.SwapItems(slotsOnInterface[obj], mouseHoverSlotData);
        }

        PlayerManager playerInventory = transform.GetComponentInParent<PlayerManager>();
        StartCoroutine(playerInventory.SaveInventory());
    }
